...
- Homepage order: Next West plate → house nav (Purpose / Events / Studio / Partners / Subscribe; Events is a dropdown of the event franchises, not a page) → drawn masthead → section rail POWER | MONEY | CITIES | FRONTIERS | CULTURE → story well (Miller as FRONTIERS lead) → speaker-faces strip → footer.
