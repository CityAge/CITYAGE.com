    ...
    <div className="min-h-screen flex flex-col bg-[#F9F9F7]">
      ...
      <main className="flex-grow max-w-[900px] mx-auto w-full px-6 md:px-12 py-12">
        ...
        <div className="border-b border-black pb-8 mb-10">
          ...
          <h1 className="type-title mt-6 tracking-tight">
            Dispatches
          </h1>
            ...
            {briefs.map((brief) => {
              ...
              return (
                ...
                >
                  ...
                  <h2 className="type-rail-h text-black group-hover:text-[#1A365D] transition-colors mb-2">
                    {brief.title}
                  </h2>
                  {tagline && (
                    <p className="type-deck text-black/40">
                      {tagline}
                    </p>
                  )}
                </Link>
