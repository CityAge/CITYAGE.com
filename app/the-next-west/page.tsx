...
const event: EventContent = {
  ...
  image: '/next-west-harbour-tug.jpg', dayImage: '/vancouver-banner.jpg', imageAlt: 'Edited view based on the site's Vancouver photograph: Stanley Park and downtown beyond Lions Gate Bridge, with a small coloured tug approaching the main span.',
  themes: [
