...
const event: EventContent = {
  ...
  image: '/next-west-harbour-clean.jpg', tugImage: '/next-west-tug-layer.webp', dayImage: '/vancouver-banner.jpg', imageAlt: 'Edited view based on the existing Vancouver photograph: Stanley Park and downtown beyond Lions Gate Bridge, with a small coloured tug approaching the main span.',
  themes: [
