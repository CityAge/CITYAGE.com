      ...
      <div className="border-b border-black/10 bg-[#F9F9F7] px-6 md:px-12 py-2">
        <div className="max-w-[1200px] mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-4 md:gap-8">
            <a href="#" className="font-mono text-[9px] tracking-[0.2em] uppercase text-black/50 hover:text-black transition-colors">Subscribe</a>
            <span className="text-black/15 text-[9px]">|</span>
            <a href="#" className="font-mono text-[9px] tracking-[0.2em] uppercase text-black/50 hover:text-black transition-colors">Log in</a>
          </div>
        </div>
      </div>
