...
export function ArticleCard({ id, title, vertical, tagline, excerpt, date, isLead, image, readTime, variant = 'default', linkPrefix = '/dispatches', href: hrefOverride }: ArticleCardProps) {
  const href = hrefOverride || `${linkPrefix}/${id}`
